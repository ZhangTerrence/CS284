...
public class TestPerson {
    public static void main(String[] args) {
        ...
        System.out.println("Age of " + p1.getGivenName()+ " is "+ p1.age(cal.get(Calendar.YEAR)));

        if (p1.isSenior(cal.get(Calendar.YEAR))) {
            System.out.println(p1.getGivenName() + " can ride the subway for free");
        } else {
            System.out.println(p1.getGivenName() + " must pay to ride the subway");
        }
        ...
        if (p1.equals(p2)) {
            ...
            System.out.println("No, p1 and p2 are two different people!");
        }
    }
}
